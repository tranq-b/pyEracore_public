class GC(object):
 ...
 def Collect(generation=None,mode=None,blocking=None,compacting=None):
  """
  CollectIds(generation: int,mode: GCCollectionMode,blocking: bool)CollectIds(generation: int,mode: GCCollectionMode,blocking: bool,compacting: bool)CollectIds(generation: int,mode: GCCollectionMode)
